...
module.exports =
{
  parallel      : __nccwpck_require__(409),
  serial        : __nccwpck_require__(61),
  serialOrdered : __nccwpck_require__(506)
};
...
var defer = __nccwpck_require__(813);
...
var async = __nccwpck_require__(324)
  , abort = __nccwpck_require__(617)
  ;
...
var abort = __nccwpck_require__(617)
  , async = __nccwpck_require__(324)
  ;
...
var iterate    = __nccwpck_require__(94)
  , initState  = __nccwpck_require__(53)
  , terminator = __nccwpck_require__(784)
  ;
...
var serialOrdered = __nccwpck_require__(506);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(597)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(713);
...
var Stream = (__nccwpck_require__(781).Stream);
var mime = __nccwpck_require__(751);
var asynckit = __nccwpck_require__(932);
var populate = __nccwpck_require__(954);
...
var db = __nccwpck_require__(707)
...
(function() {
  ...
  writeSync = (__nccwpck_require__(872).sync);
...
const threadId = (function getId () {
  try {
    const workerThreads = __nccwpck_require__(267)
...
exports["default"] = {
    API_BASE_URL: "https://api.gojekapi.com/",
    GOID_BASE_URL: "https://goid.gojekapi.com/",
    CUST_BASE_URL: "https://customer.gopayapi.com/",
    CLIENT_ID: "gopay:consumer:app",
    CLIENT_SECRET: "raOUumeMRBNifqvZRFjvsgTnjAlaA9",
    MFA_CLIENT_ID: "6d11d261d7ae462dbd4be0dc5f36a697-MFAGOJEK",
};
...
var credential_util_1 = __nccwpck_require__(690);
var gopay = {
    auth: auth,
    bank: bank,
    customer: customer,
    init: credential_util_1.init,
};
...
var http_util_1 = __nccwpck_require__(711);
var api_constant_1 = __importDefault(__nccwpck_require__(552));
var credential_util_1 = __nccwpck_require__(690);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validateBankAccount = exports.getBanks = void 0;
var http_util_1 = __nccwpck_require__(711);
var getBanks = function () { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, http_util_1.httpCust.get("/v1/banks?type=transfer")];
            case 1:
                res = _a.sent();
                return [2 /*return*/, res.data];
        }
...
var validateBankAccount = function (bankCode, accountNumber) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, http_util_1.httpCust.get("v1/bank-accounts/validate?bank_code=".concat(bankCode, "&account_number=").concat(accountNumber))];
            case 1:
                res = _a.sent();
                return [2 /*return*/, res.data];
        }
...
var axios_1 = __importDefault(__nccwpck_require__(556));
var api_constant_1 = __importDefault(__nccwpck_require__(552));
var credential_util_1 = __nccwpck_require__(690);
var baseHeaders = {
...
const FormData$1 = __nccwpck_require__(221);
